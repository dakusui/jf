...
However, in this situation, where each notation and application has its own syntax sugars, user experiences across applications become inconsistent and poor.
