...
To address these challenges, we have created a tool called **jq-front**<<jq-front>> and a pipeline that employs it.
...
include::allYouNeed-appendix-builtInFunctions.adoc[]
