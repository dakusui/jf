...
In our approach, we identify the human readability and the capability to make the descriptions of structured information and complex constraints "D-R-Y"ed are completely independent concerns.
